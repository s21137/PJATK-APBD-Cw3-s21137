...
public static class DaneUczelni
{
    ...
    public static void Inicjalizuj()
    {
        ...
        [
            ...
            new Przedmiot { Id = 3, Nazwa = "Analiza Danych w C#", Kategoria = "Analytis", Ects = 6, ProwadzacyId = 3, DataStartu = new DateTime(2026, 4, 1), DataZakonczenia = new DateTime(2026, 7, 10) },
